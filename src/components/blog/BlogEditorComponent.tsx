...
const BlogEditorComponent = () => {
  ...
  const [sectionFourParagraphFooter, setSectionFourParagraphFooter] =
    useState("");
  // section 5
  ...
  const [sectionSixColOneParagraph, setSectionSixColOneParagraph] =
    useState("");
  ...
  const [sectionSixColTwoParagraph, setSectionSixColTwoParagraph] =
    useState("");
