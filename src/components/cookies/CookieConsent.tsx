    ...
    <div className="backdrop fixed top-0 left-0 w-full h-full bg-black bg-opacity-40 z-[555]">
      <div className="bg-background ml-0 fixed bottom-1/4 maxsm:bottom-5 left-1/2 maxmd:left-1/3 w-full maxsm:w-[90%] maxmd:w-[80%] maxlg:w-1/2 maxxl:w-1/3 max-w-2xl py-16 p-8 m-4 flex flex-col items-center justify-center transform -translate-x-1/2 maxmd:-translate-x-1/3  bg-secondary-gradient text-foreground z-[888] mx-auto shadow-lg rounded-md ">
        ...
        <Image
          ...
          width={250}
          height={250}
          className="-mt-20 z-[890] w-36 h-36"
        />
        <div className="flex flex-col items-center justify-center text-center">
          <p className="text-sm maxsm:text-xs tracking-wider mt-3">
          ...
          <div onClick={acceptConsent} className="mt-3 text-xs tracking-wider">
            <Link href={"/politica"}>
              <p>Leer Mas...</p>
            </Link>
          </div>
          <div className="flex flex-col items-center gap3 mt-2">
            <button
              ...
              className="bg-red-700 hover:bg-red-800 text-white text-sm px-6 py-2 rounded mr-2 tracking-wide my-3"
            >
              Continuar
            </button>
