...
const WinnerPicker: React.FC<WinnerPickerProps> = ({
  ...
  return (
    <div className="winner-picker flex items-center justify-center flex-col min-h-screen relative overflow-hidden">
      <button
        onClick={handleSpin}
        disabled={isSpinning}
        ...
        <>
          {winnerData?.name && (
            <div className="fixed top-0 left-0 w-full min-h-screen flex items-center justify-center z-50 bg-black bg-opacity-50">
              <div className="max-w-[500px] relative text-center bg-slate-300 p-6 rounded-lg shadow-lg">
