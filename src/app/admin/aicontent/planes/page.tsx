...
import { frequencies, tiers } from "./_components/PlanesDetails";
...
export default function PricingPage() {
  ...
  return (
    <div
      className={cn(
        "bg-background flex flex-col w-full items-center fancyOverlay"
      )}
    >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-5">
            ...
            {tiers.map((tier, index) => {
              return (
                <div
                  key={tier.id}
                  className="flex flex-col items-center bg-white dark:bg-gray-900/80 backdrop-blur-md mx-auto mt-4 max-w-sm rounded-3xl ring-1 ring-gray-300/70 dark:ring-gray-700 xl:mx-0 xl:flex xl:max-w-none"
                >
                  <div className="p-8 sm:p-10 xl:flex-auto">
                    ...
                    <p className="mt-6 text-sm leading-7 text-gray-700 dark:text-gray-400">
                      {tier.description}
                    </p>
                    ...
                    <ul className="mt-10 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-700 dark:text-gray-400">
                      {tier.features.map((feature) => (
                        ...
                        >
                          <CheckIcon
                            className="h-6 w-6 flex-none text-green-700"
                            aria-hidden="true"
                          />
                          {feature}
                        </li>
                  ...
                  <div className="-mt-2 p-2 xl:pr-8 xl:mt-0 w-full xl:max-w-md xl:flex-shrink-0">
                    <div
                      className={cn(
                        "rounded-2xl py-10 text-center ring-1 ring-inset ring-gray-300/50 dark:ring-gray-800/50 xl:flex xl:flex-col xl:justify-center xl:py-16 fancyGlass"
                      )}
                    >
